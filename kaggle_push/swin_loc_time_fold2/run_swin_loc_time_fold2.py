...
class Args:
    ...
    seed = 42
    model_subdir = "swin_v2_temporal_two_head_loc_time_fold2"
    band_stats_root = band_stats_root
    use_location_features = True
    location_metadata_path = str(repo / "data" / "location_coordinates_geocoded.csv")
    location_feature_mode = "local_time"
    no_pretrained = False
    no_amp = True
