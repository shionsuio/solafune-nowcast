...
|---|---:|
| `submission_swin80_twohead_hg20.zip` | `0.6648436931975658` |
...
| recipe | Public LB | fold2 RMSE | eval-like sqrt | top30 |
|---|---:|---:|---:|---:|
| twohead100 | 0.667495 | 1.2268 | 1.2748 | 1.5515 |
| wh50_twohead50 | 0.667971 | 1.2212 | 1.2670 | 1.5366 |
| wh80_twohead20 | 0.668802 | 1.2294 | 1.2714 | 1.5303 |
| wh_hg20 | 0.669028 | 1.2345 | 1.2751 | 1.5303 |
| wh100 | 0.669584 | 1.2396 | 1.2781 | 1.5271 |
...
|---|---:|
| `submission_swin80_twohead_hg20.zip` | `0.6648436931975658` |
| `submission_swin80_twohead_hg15.zip` | `0.664896294015942` |
| `submission_swin80_twohead_hg10.zip` | `0.664968320977189` |
| `submission_swin80_twohead_hg05.zip` | `0.6650597775112403` |
| `submission_swin80_twohead_goes10.zip` | `0.6650759632713459` |
| `submission_swin80_twohead_goes05.zip` | `0.6651187430534208` |
| `submission_swin80_temporal20.zip` | `0.665170659850418` |
| `submission_swin70_temporal30.zip` | `0.6652041538889646` |
| `submission_swin90_temporal10.zip` | `0.6652853968024254` |
| `submission.zip` | `0.6655480991569234` |
| `submission_swin_twohead_fold02_stable134.zip` | `0.6674952809153677` |
| `submission_unet_v2.zip` | `0.6944421608854776` |
...
| blend | Public LB |
|---|---:|
| HG05 | `0.6650597775112403` |
| HG10 | `0.664968320977189` |
| HG15 | `0.664896294015942` |
| HG20 | `0.6648436931975658` |
...
### D. pseudo-labelingルール確認 — ユーザー対応待ち
...
- location は train/eval overlap 0。location 直接特徴は危険。
- manual coordinate はルール確認が必要。外部データ扱いの可能性があるため、採用は慎重に。
